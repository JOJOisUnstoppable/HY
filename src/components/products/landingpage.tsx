...
export const fastenerIndustries: Industry[] = [
...
export const IndustryApplicationsSection = ({ industries }: IndustryApplicationsSectionProps) => (
...
export const FaqSection = ({ faqs, expandedFaq, toggleFaq }: FaqSectionProps) => (
